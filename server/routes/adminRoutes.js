...
router.get("/", authMiddleware, requireRole("admin") , fetchHomeInfo);
router.get("/profile", authMiddleware, requireRole("admin"), getAdminProfile);
router.put("/profile", authMiddleware, requireRole("admin"), updateAdminProfile);
